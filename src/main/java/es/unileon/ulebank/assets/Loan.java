...
@Entity
@Table(name="loans") 
public class Loan implements FinancialProduct, Serializable {
	 ...
	 */
	@Embedded
	private GenericLoanHandler idLoan;
...
//	private Account account;
	...
	public Loan() throws LoanException {
...
//		this.strategy = new GermanMethod(this);
//		this.payments = this.strategy.doCalculationOfPayments();
	 ...
	 */
	public Loan(GenericLoanHandler idLoan, double initialCapital, double interest,
...
//		}
	...
	public void setId(GenericLoanHandler idLoan) {
		this.idLoan = idLoan;
	}
...
//	}
	...
	public Account getLinkedAccount() {
		...
		try {
			...
			commercialAccount = new Account(office, bank, "0000000000");
...
//		return this.account;
	...
	public Handler getIdLoan() {
		return idLoan;
	}

	public void setIdLoan(GenericLoanHandler idLoan) {
		this.idLoan = idLoan;
	}
...
//	}
	...
	public FeeStrategy getCancelCommission() {
		return cancelCommission;
	}

	public FeeStrategy getStudyCommission() {
		return studyCommission;
	}

	public FeeStrategy getOpenningCommission() {
		return openningCommission;
	}

	public FeeStrategy getModifyCommission() {
		return modifyCommission;
	}

	public FeeStrategy getAmortizedCommission() {
		return amortizedCommission;
	}
